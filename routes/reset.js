...
module.exports = (app, io) => {
    ...
    app.get('/forgot_password', (req, res) => {
        ...
        res.render('forgot', {title: 'ABES-FAMILY | Forgot Password', messages: errors, hasErrors: errors.length > 0, info: info, noErrors: info.length > 0})        
    });
        ...
        async.waterfall([
            ...
            function(token, user, callback){
                ...
                var mailOptions = {
                    ...
                    subject: 'ABES-FAMILY Password Reset Token',
